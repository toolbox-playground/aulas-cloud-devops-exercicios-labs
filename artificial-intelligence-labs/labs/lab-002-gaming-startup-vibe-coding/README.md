# Lab 002 - Gaming Startup com Vibe Coding (fadada ao fracasso)

## Objetivo

Medir a capacidade de cada modelo ao receber prompts simples para criar jogos complexos.
...
2. Execute os prompts fácil, médio e difícil em cada IA.
3. Salve cada resposta como arquivo `.html`.
4. Abra os arquivos no navegador (Chrome/Edge).
5. Avalie jogabilidade, performance, erros de execução e qualidade visual.
