...
```text
/superpowers:using-superpowers a partir do conhecimento adquirido nos plugins, como frontend, canva e suporpowers, crie skills locais no projeto atual para desenvolvimento de games html, css, javascript  e matter.js que rodem em browsers com física, jogabilidade e dinamica perfeita.
```
